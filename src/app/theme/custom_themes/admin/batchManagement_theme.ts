...
const getBatchManagementTheme = (mode = "light") => {
  ...
  return {
    ...
    implementationModal: {
      ...
      content: { px: 3, pt: 4, pb: 2, flex: 1, overflowY: "auto", overflowX: "hidden" },
      materialsTable: {
        container: {
          width:        "100%",
          overflowX:    "auto",
          overflowY:    "visible",
          border:       `1px solid ${d.dividerColor}`,
          borderRadius: general.borderRadius.md,
        },
        table: { minWidth: 1180 },
        headCell: {
        ...
        bodyCell: { px: 1, py: 1, verticalAlign: "top" },
        srNoCell:         { width: 52, minWidth: 52 },
        codeCell:         { minWidth: 96 },
        nameCell:         { minWidth: 110 },
        lotCell:          { minWidth: 130 },
        manufacturerCell: { minWidth: 110 },
        numericCell:      { minWidth: 88 },
        dateCell:         { minWidth: 128 },
        actionCell:       { minWidth: 76, whiteSpace: "nowrap" },
      },
    },
    ...
    detailsDialog: {
      ...
      header: {
        ...
        title:     { color: colors.white.text, fontWeight: fonts.weight.bold, fontSize: fonts.size.md, lineHeight: fonts.lineHeight.tight },
        subtitle:  { color: colors.white.textMuted, fontSize: fonts.size.xs },
        chipRow:   { display: "flex", flexWrap: "wrap", gap: 0.75, alignItems: "center", mt: 0.75 },
        closeButton: { color: colors.white.textMuted, "&:hover": { bgcolor: colors.overlay.lightHover } },
      },
      content: {
        px:        3,
        ...
        flex:      1,
        overflowY: "auto",
        bgcolor:   isDark ? d.pageBg : alpha(accentBlue, 0.02),
      },
      section: {
        mb:           2.5,
        p:            2,
      ...
      metaItem: {
        p:            1.25,
        borderRadius: general.borderRadius.md,
        bgcolor:      isDark ? alpha(accentBlue, 0.06) : alpha(accentBlue, 0.04),
        border:       `1px solid ${alpha(accentBlue, 0.12)}`,
      },
      metaLabel: {
        fontSize:      "0.62rem",
        fontWeight:    fonts.weight.bold,
      ...
      workflowStrip: {
        ...
        borderRadius:  general.borderRadius.md,
        border:        `1px solid ${d.dividerColor}`,
        bgcolor:       isDark ? alpha(accentBlue, 0.06) : alpha(accentBlue, 0.03),
      },
      workflowLabel: {
        fontSize:      "0.62rem",
        fontWeight:    fonts.weight.bold,
      ...
      loadingText: { fontSize: fonts.size.sm, fontWeight: fonts.weight.semibold, color: d.textSecondary },
      emptyText:   { fontSize: fonts.size.sm, color: d.textSecondary, textAlign: "center", py: 3 },
      footer: {
        px:             3,
        py:             2,
        gap:            spacing.sm,
      ...
      materialsTable: {
        ...
        headCell: {
          ...
          letterSpacing: "0.04em",
          textTransform: "uppercase",
          bgcolor:       isDark ? alpha(accentBlue, 0.08) : alpha(accentBlue, 0.05),
        ...
        bodyRow: (idx: number) => ({
          bgcolor: idx % 2 === 0 ? "transparent" : isDark ? "rgba(255,255,255,0.02)" : "rgba(0,0,0,0.015)",
        }),
      },
    },
